...
class BuildCreateResultClassPromptAction : AnAction() {
    ...
    private class ContextInputDialog : DialogWrapper(true) {
        ...
        init {
            init()
            title = "Nhập thông tin result class cần tạo"
        }
        ...
        fun buildCreateEnumPrompt(): String {
            ...
            if (className.isEmpty()) {
                return "- feature: $feature \n- requirement: $requirement \n=> create all class represent output of function need for feature from requirement like this file"
            }
            return "- feature: $feature \n- requirement: $requirement \n=> create class $className represent output of function need for feature from requirement like this file"
